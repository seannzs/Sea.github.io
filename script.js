...
// Foto yang membentuk galaxy (lihat config.js untuk mengubah/menambah foto)
const configHeartImages = (window.appConfig && window.appConfig.heartImages && window.appConfig.heartImages.length > 0)
  ? window.appConfig.heartImages
  : defaultHeartImages;
...
//Ganti Deskripsi Planet (lihat config.js untuk mengubah teksnya)
const ringTexts = [
  ...(window.appConfig && window.appConfig.ringTexts ? window.appConfig.ringTexts : []),
